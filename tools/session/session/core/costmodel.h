#ifndef SESSION_CORE_COSTMODEL_H_
#define SESSION_CORE_COSTMODEL_H_
#include <vector>
...
class CostModel {
    ...
    private:
        ...
        std::vector<std::vector<Bytes>> slot_bytes_;
        ...
        struct MemUsage {
            ...
            std::vector<Bytes> output_port_mem;
            std::vector<TensorShapeProto> output_port_shape;
            std::vector<DataType> output_port_type;
        };
        std::vector<MemUsage> max_mem_usage_;

        std::vector<std::vector<int64>> output_port_alloc_ids_;
