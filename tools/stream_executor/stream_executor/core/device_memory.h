#ifndef STREAM_EXECUTOR_CORE_DEVICE_MEMORY_H_
#define STREAM_EXECUTOR_CORE_DEVICE_MEMORY_H_
#include <cstdint>
#include <cstddef>
...
class DeviceMemoryBase{
    ...
    private:
        ...
        uint64_t payload_ = 0;  // Payload data associtated with this allocation.
};
