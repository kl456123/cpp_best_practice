...
#include "stream_executor/platform/env.h"
...
#include "stream_executor/platform/env_time.h"
#include "stream_executor/platform/errors.h"
#include "stream_executor/platform/host_info.h"
#include "stream_executor/platform/path.h"
#include "stream_executor/platform/platform.h"
#include "stream_executor/platform/protobuf.h"
#include "stream_executor/platform/stringprintf.h"
...
#undef DeleteFile
#undef CopyFile
#include "stream_executor/platform/windows/wide_char.h"
