...
#include "stream_executor/platform/threadpool.h"

#define EIGEN_USE_THREADS

#include "absl/types/optional.h"
#include "third_party/eigen3/unsupported/Eigen/CXX11/Tensor"
#include "stream_executor/platform/blocking_counter.h"
#include "stream_executor/platform/context.h"
#include "stream_executor/platform/denormal.h"
#include "stream_executor/platform/logging.h"
#include "stream_executor/platform/mutex.h"
#include "stream_executor/platform/numa.h"
#include "stream_executor/platform/setround.h"
#include "stream_executor/platform/tracing.h"
...
ThreadPool::ThreadPool(thread::ThreadPoolInterface* user_threadpool) {
  ...
  threadpool_device_.reset(new Eigen::ThreadPoolDevice(
      underlying_threadpool_, underlying_threadpool_->NumThreads()));
}
